...
echo "Building..."
g++ main.c experiment_noise.c ExponentionalRegression.c linear.c precision_analysis.c \
 -o experiment_noise.out -D _DEBUG -g -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-align -Wcast-qual \
